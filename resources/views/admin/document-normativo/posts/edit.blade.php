...
@section('content')
    <div class="card">
        <div class="card-body">
            {!! Form::model($post,['route' => ['admin.documentos-normativos-posts.update',$post],'autocomplete'=>'off','files'=>true,'method'=>'put']) !!}
       ...
       {{--      {!! Form::hidden('user_id', auth()->user()->id) !!} --}}
            ...
            <div class="row mb-5">
                <div class="col">
                    <div class="image-wrapper">
                        <iframe id="picture" src="{{Storage::url($post->file->url)}}" ></iframe>
            ...
            {!! Form::submit('Actualizar Docuemnto', ['class' => 'btn btn-primary']) !!}
